...
enum layer_name { _BASE, _F1, _F2, _NUM, _BASE_2, _GAMING, _6 };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN2] = LAYOUT(
            ...
            _______, _______, _______, _______, _______, KC_BKWD, KC_LCTL, _______, KC_NEXT, _______, _______, _______, _______, _______,
                                       KC_DEL , KC_LGUI,MO(_NUM), MO(_5) , _______, _______, KC_LCTL, KC_LALT
            ),
    ...
    [_GAMING] = LAYOUT(
            ...
            KC_LSFT, KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , _______, _______, _______, _______, _______, _______, _______, _______,
